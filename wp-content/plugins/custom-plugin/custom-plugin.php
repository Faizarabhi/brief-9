...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'Footer Setting', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/Vector.png'));
    ...
    function tryvary_include_inline_css()
{
    ...
    <style>
        .footer{
        background-color:#001e6c;color:white;display:flex;justify-content: space-between;align-items: center;padding:10px;font-family: 'Roboto', sans-serif;
        }
        .footer-right{
